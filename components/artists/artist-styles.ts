/** Artist Index brand accent — matches UI reference (#E8192C) */
export const HIFFI_ARTIST_RED = "#E8192C"

/** Outer directory card shell — generous corner radius from UI reference */
export const artistCardShell =
  "rounded-[1.25rem] border border-border bg-white shadow-sm transition-shadow hover:shadow-md"

/** Inset media block: curved top, flat bottom where content begins */
export const artistCardMedia =
  "relative overflow-hidden rounded-2xl bg-zinc-950"
...
export const artistCardButtonPrimary =
  "inline-flex items-center justify-center gap-2 rounded-xl bg-[#E8192C] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#d01528]"

export const artistCardButtonSecondary =
...
/** Panels on the index page (empty states, claim banner) */
export const artistPanelShell = "rounded-[1.25rem]"
