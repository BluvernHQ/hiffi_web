    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
          Hiffi is built for hip-hop streaming — the platform where independent rap artists and
          their fans come first. Discover official music videos, follow creators, and stream
          drill, trap, conscious rap, boom bap, underground rap, and new rap music.
        </p>
